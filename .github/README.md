...
[`@aws-sdk/client-iotanalytics`](https://www.npmjs.com/package/@aws-sdk/client-iotanalytics/v/3.369.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iotanalytics@3.369.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NIsI7+cvTvFK00KjUzgECmpptwce8DXXqofOP5N9XZh82ONlz0sokc90YEQlaiiL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-iotanalytics": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iotanalytics@3.369.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iotanalytics@3.369.0/index.min.mjs": "sha384-NIsI7+cvTvFK00KjUzgECmpptwce8DXXqofOP5N9XZh82ONlz0sokc90YEQlaiiL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-iotanalytics/blob/refs/tags/3.369.0/LICENSE
```
