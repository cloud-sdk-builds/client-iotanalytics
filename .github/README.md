...
[`@aws-sdk/client-iotanalytics`](https://www.npmjs.com/package/@aws-sdk/client-iotanalytics/v/3.4.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iotanalytics@3.4.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-c3085w1yKiQfqPNbnyek3SbFX2XYenkdwvR00reFAW1PDE4E7tTCaCXOde6WntaN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-iotanalytics": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iotanalytics@3.4.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iotanalytics@3.4.1/index.min.mjs": "sha384-c3085w1yKiQfqPNbnyek3SbFX2XYenkdwvR00reFAW1PDE4E7tTCaCXOde6WntaN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-iotanalytics/blob/refs/tags/3.4.1/LICENSE
```
